...
\Exercise{40}
\label{exercise:quotient-group:commutator-of-x-y}
Let $G$ be a group, let $N$ be a normal subgroup of $G$ and let
...
\Exercise{41} Let $G$ be a group. Prove that
$N = \gen{x^{-1}y^{-1}xy\mid x,y\in G}$ is a normal subgroup of $G$
and $G/N$ is abelian ($N$ is called the {\em commutator subgroup} of
$G$).
\begin{proof}

...
\Exercise9
\label{exercise:quotient-group:jordan-holder-2-special-case}
...
\Exercise{10} Prove part (2) of the Jordan--H\"older Theorem by
...
% \Exercise{11} Prove that if $H$ is a nontrivial normal subgroup of the
% solvable group $G$ then there is a nontrivial subgroup $A$ of $H$ with
% $A\trianglelefteq G$ and $A$ abelian.

\Exercise{12} Prove (without using the Feit--Thompson Theorem) that
